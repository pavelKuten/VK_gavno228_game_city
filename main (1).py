...
vk_session = vk_api.VkApi(token="f0c12d956a5e768289de35e91d7b41cc41002c58b186d91788e251755d9b40dc4e8a79831c299a6737c2d")
        ...
        if is_message(event):
            if is_play_game(event):
                ...
                if not igra.is_unused_city(city):
                    send_message(user1, 'Ты проиграл, так как назвал город, который уже был!')
